...
const create = async (req) => {
  ...
  try {
    ...
    if (findActiveTemplate) {
      console.log("Active Template Exists, Updating...");
      ...
      if (findActiveTemplate.templateId !== req.body.templateId) {
        console.log("TemplateId has changed, updating...");
        ...
        console.log("TemplateId hasn't changed, no update necessary.");
        result = findActiveTemplate;
      }
    } else {
      console.log("Creating New Active Template...");
      ...
      console.log("New Active Template Created:", result);
